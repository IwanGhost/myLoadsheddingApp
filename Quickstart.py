...
def callStatus():
    ...
    # check if day changed, then reset prev_status otherwise events won't be added, due to if check
...
# Main function, being initialised by __name__ == '__main__'
def main():
